...
class TaxiApp_Booking_Info extends TaxiApp_Booking_Abstract
{
    ...
    {    
		...
		{ 
            ...
            if( $rateInfo = self::calcRateOptions( $bookingInfo, $bookingInfo['rateservice_id'] ) )
            {
                $rateInfo = array_pop( $rateInfo );
            }
            ...
            $overview = '
                ...
                <div style="' . $boxCss . '"><span style="' . $smallTitleCss . '">Estimated Rate:</span> ' . $currency . $rateInfo['rate'] . ' (' . $currency . intval( $bookingInfo['paid']) . ' paid)</div>
                <div style="' . $boxCss . '"><span style="' . $smallTitleCss . '">Distance:</span> ' . $routeInfo['distance']['text'] . '</div>
                <div style="' . $boxCss . '"><span style="' . $smallTitleCss . '">Service:</span> ' . $rateInfo['rateservice_name'] . ' - ' . $rateInfo['rateservice_description'] . '</div>
            ';
