 ...
 *
 * @category   PageCarton
 * @package    TaxiApp_Rate_RateService_Editor
...
class TaxiApp_Rate_RateService_Editor extends TaxiApp_Rate_RateService_Abstract
{
    ...
    {    
		...
		{ 
			...
			$this->createForm( 'Save', 'Edit Rate Service Information ', $data );
